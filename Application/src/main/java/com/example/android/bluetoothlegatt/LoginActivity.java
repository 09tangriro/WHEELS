...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            for (String email : DUMMY_CREDENTIALS.keySet()) {
                if(email.equals(mEmail)){
                    String authPassword = DUMMY_CREDENTIALS.get(email);
                    if(authPassword.equals(mPassword)){
                        return true;
                    }
                    else{
                        return false;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                saveBooleanInSP(getApplicationContext(), true);
                scanIntent(getApplicationContext());
            } else {
    ...
    public static void saveBooleanInSP(Context _context, boolean value){
        SharedPreferences preferences = _context.getSharedPreferences("WHEELS", android.content.Context.MODE_PRIVATE);
    ...
    private void scanIntent(Context context){
        final Intent scanner = new Intent(context, DeviceScanActivity.class);
